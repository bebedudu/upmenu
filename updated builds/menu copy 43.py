# screen brightness toggler added and shortcut key optimized
...
default_shortcuts = {
    "Show/Hide Menu": "<ctrl>+<alt>+n",
    "Take Screenshot": "<ctrl>+<alt>+t",
    "Open Calculator": "<ctrl>+<alt>+d",
    "Open Homepage": "<ctrl>+<alt>+i",
    "Restart Programs": "<ctrl>+<alt>+q",
    "Toggle Brightness": "<ctrl>+<alt>+a"
}
...
def listen_for_shortcuts():
    ...
    kb.add_hotkey("ctrl+alt+m", lambda: on_active_show_hide())  # show/hide the menu
...
def setup_keyboard_shortcuts():
    ...
    hotkeys = {
        ...
        shortcuts["Toggle Brightness"]: toggle_brightness
    }
