# added the keybord enabled/disabled in the context menu and volume mixer
...
def show_volume_mixer():
    global volume_mixer_window, scrollable_frame
    volume_mixer_window = tk.Toplevel(root)
    volume_mixer_window.title("Application Volume Adjuster")
    volume_mixer_window.configure(background="#333333")
    ...
    style.configure("TLabel", background="#333333", foreground="#d2d2d2")

    # Create a canvas and scrollbar to make the window scrollable
    canvas = tk.Canvas(volume_mixer_window, background="#333333")
