...
timer_widget.place(relx=0.15, rely=0.85, anchor="sw")  # Adjust position as needed
...
# Add this to your UI layout
bookmarks_widget = create_bookmarks_widget(canvas)
bookmarks_widget.place(relx=0.35, rely=0.85, anchor="sw")  # Adjust position as needed


# Add this before the root.mainloop() call but after creating the main UI elements
# Create a section for additional widgets
additional_widgets_frame = tk.Frame(main_container, bg="#222222")
additional_widgets_frame.pack(pady=(1, 1))

# system_monitor_widget = create_system_monitor(additional_widgets_frame)
# system_monitor_widget.pack(side=tk.LEFT, padx=10)

shortcuts_widget = create_shortcuts_manager(additional_widgets_frame)
shortcuts_widget.pack(side=tk.LEFT, padx=10)

timer_widget = create_timer_widget(additional_widgets_frame)
timer_widget.pack(side=tk.LEFT, padx=10)

bookmarks_widget = create_bookmarks_widget(additional_widgets_frame)
bookmarks_widget.pack(side=tk.LEFT, padx=10)
