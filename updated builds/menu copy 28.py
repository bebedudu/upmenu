# mousewheel added in volume and brightness
...
canvas = tk.Canvas(root, width=900, height=300, bg="white", highlightthickness=0)
canvas.pack(pady=0)
...
canvas.create_rounded_rect(
    ...
    900, 300,  # Original width and height
    radius,
    fill=shadow_color,
    outline=""
)
...
network_frame.place(relx=0.75, rely=0.98, anchor="se")  # Place before datetime
...
datetime_widget.place(relx=0.98, rely=0.95, anchor="se")  # Keep at far right

# Update the rounded rectangle size
canvas.create_rounded_rect(0, 0, 900, 300, radius, fill="#222222", outline="")
