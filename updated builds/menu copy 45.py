# added the list open windows in the 2nd menu page
...
def list_open_windows_window():
    ...
    def refresh_window_list():
        ...
        for window in filtered_windows:
            ...
            # Restore selection if it matches the previously selected window
            if window == selected_window_title:
                window_list.selection_set(tk.END)
    ...
    # Create the list open windows window
...
def create_second_page(parent):
    ...
    # list open windows
    list_open_windows_widget = tk.Button(tools_frame, text="List Open Windows", command=list_open_windows_window, bg="#333333", fg="#d2d2d2")
    ...
    # Edit Shortcuts
    edit_shortcuts_button = tk.Button(tools_frame, text="Edit Shortcuts", command=open_shortcut_editor, bg="#333333", fg="#d2d2d2")
