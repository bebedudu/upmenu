# now toggling volume mixer shows the application volume mixer
...
def show_volume_mixer(event=None):
    ...
    volume_mixer_window.configure(background="#222222")
    ...
    canvas = tk.Canvas(volume_mixer_window, background="#222222")
