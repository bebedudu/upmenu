# optimized logs and tooltip added and more @ searches added 
...
def create_top_controls(parent):
    ...
    ToolTip(search_entry, f"@youtube, @maps, @images, @amazon, @flipkart, @wiki, @wikihow, @github, \n @translate, @stackoverflow, @reddit, @quora, @medium, @linkedin, @twitter/@x, @news, \n @scholar, @weather, @duckduckgo, @spotify, @coursera, @udemy, @discord, @pinterest, \n @unsplash, @google")
    ...
    # Create tooltip with all search shortcuts
    # shortcuts_text = "Search Shortcuts:\n"
    # shortcuts_text += "@youtube - Search YouTube\n"
    # shortcuts_text += "@maps - Search Google Maps\n"
    # shortcuts_text += "@images - Search Bing Images\n"
    # shortcuts_text += "@amazon - Search Amazon\n"
    # shortcuts_text += "@flipkart - Search Flipkart\n"
    # shortcuts_text += "@wiki - Search Wikipedia\n"
    # shortcuts_text += "@wikihow - Search WikiHow\n"
    # shortcuts_text += "@github - Search GitHub\n"
    # shortcuts_text += "@translate - Google Translate\n"
    # shortcuts_text += "@stackoverflow - Search Stack Overflow\n"
    # shortcuts_text += "@reddit - Search Reddit\n"
    # shortcuts_text += "@quora - Search Quora\n"
    # shortcuts_text += "@medium - Search Medium\n"
    # shortcuts_text += "@linkedin - Search LinkedIn\n"
    # shortcuts_text += "@twitter/@x - Search Twitter/X\n"
    # shortcuts_text += "@news - Search Google News\n"
    # shortcuts_text += "@scholar - Search Google Scholar\n"
    # shortcuts_text += "@weather - Search Weather\n"
    # shortcuts_text += "@duckduckgo - Search DuckDuckGo\n"
    # shortcuts_text += "@spotify - Search Spotify\n"
    # shortcuts_text += "@coursera - Search Coursera\n"
    # shortcuts_text += "@udemy - Search Udemy\n"
    # shortcuts_text += "@discord - Search Discord\n"
    # shortcuts_text += "@pinterest - Search Pinterest\n"
    # shortcuts_text += "@unsplash - Search Unsplash\n"
    # shortcuts_text += "@google - Search Google\n"
    # shortcuts_text += "\nYou can also enter a direct URL starting with http:// or https://"    
    # create_tooltip(search_entry, shortcuts_text)
