# added the autostart, logging, and notification
...
# Modify arrange_buttons function to remove bottom_controls handling
def arrange_buttons(event=None):
    ...
    for i, button in enumerate(button_widgets):
        row = (i // buttons_per_row) + 2  # Add 2 to start after all controls
