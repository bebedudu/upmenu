# wrapped user defined application
...
def create_app_launcher(parent):
    ...
    canvas = tk.Canvas(container, bg="#222222", highlightthickness=0, width=780, height=50)
    ...
    def update_app_buttons():
        ...
        row_frame = None
        buttons_per_row = 8  # Adjust this number based on desired button density
        current_row = []
    ...
    # Add and Remove buttons (keep existing code)
