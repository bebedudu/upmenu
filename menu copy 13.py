...
canvas = tk.Canvas(root, width=900, height=250, bg="white", highlightthickness=0, highlightbackground="lightgray")
canvas.pack()

# Draw rounded rectangle
radius = 20
canvas.create_rounded_rect(0, 0, 900, 250, radius, fill="#222222", outline="lightgray")

# Center the window on the screen
window_width = 900
window_height = 250  # Reduced height for single row
