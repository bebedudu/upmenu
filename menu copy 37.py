# butter smooth optimization
# system monitor is not working
...
# Modify the create_system_monitor function to expose the update function
def create_system_monitor(parent):
    """Create a system resource monitor widget"""
    global system_monitor_ref, update_system_stats_ref
    ...
    # Store reference to the update function globally
    # global update_system_stats
