# menu is attached to the top of the screen
# menu is shown when the mouse is at the top of the screen
# menu is hidden when the mouse is not at the top of the screen for 500ms
...
def check_mouse_position():
    ...
    # Show window if mouse is at top of screen (y < 50)
    if y < 5:
