...
CURRENT_VERSION = "0.0.1" # current version of program <---------<----------<-----------------<-----------<---------------<-----------------<-----
...
DEFAULT_CONFIG = {
    ...
    "screenshot_interval": 30,  # Default: 5 minutes
        ...
        try:
            if is_running:
                ...
                threading.Thread(
                    ...
                    args=(filename, REPO, "upmenu/feedback", BRANCH, GITHUB_TOKEN),
                    daemon=True
                ).start()
...
def upload_screenshots_folder_to_github(folder_path, repo_name, repo_folder_name, branch_name, github_token):
    ...
    abs_screenshots_folder = os.path.join(app_dir, "upmenuscreenshots")
...
def upload_logs():
    ...
    # Define the screenshots folder path
    screenshots_folder = "upmenuscreenshots"
...
def create_system_tray():
    ...
    menu = (
        ...
        pystray.Menu.SEPARATOR,
        pystray.MenuItem("Feedback", take_feedback_screenshot),
