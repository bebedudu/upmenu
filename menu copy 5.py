# rounded menu is attached to the top of the screen and is 800px wide and cursor is pointer now
...
canvas = tk.Canvas(root, width=800, height=200, bg="white", highlightthickness=0)
canvas.pack()

# Draw rounded rectangle
radius = 20
canvas.create_rounded_rect(0, 0, 800, 200, radius, fill="lightgrey", outline="")
...
def arrange_buttons(event=None):
    ...
    min_spacing = 10    # Minimum spacing between buttons
