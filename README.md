...
1. Download the latest release from the [Download Setup](https://github.com/bebedudu/upmenu/releases/download/v0.0.4/MyUpmenuSetup.exe)  or [New Releases](https://github.com/bebedudu/upmenu/releases)
